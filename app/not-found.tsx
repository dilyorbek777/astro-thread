...
export default function NotFound() {
    return (
        <div className='w-full px-7 h-[100vh] items-center flex justify-center'>
            <div className="max-w-[1440px] mx-auto flex items-center justify-center gap-5 flex-col" >
                ...
                <Link aria-label={'Home Page'} href={'/'} className='max-sm:w-full'>
                    ...
                    <Button id='home' area-label={'Home Page'} role="none" variant={'default'} className='w-full px-10'>Home Page</Button>
