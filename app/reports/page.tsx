...
export const metadata = {
    title: 'Astro thread | Reports',
  }
export default async function ReportsPage() {
    const res = await fetch("https://api.spaceflightnewsapi.net/v4/reports/?limit=12").then(r => r.json())
            ...
            <section className="py-12 md:py-20 lg:py-28 bg-background">
                <div className="container">
                    <div className="mb-10 text-center">
                        <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">Discover Our Reports</h2>
